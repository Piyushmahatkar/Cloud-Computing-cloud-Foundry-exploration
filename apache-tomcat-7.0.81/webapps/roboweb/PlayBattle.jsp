...
<script type="text/javascript">
	function Play(){
		window.location = "robocode.html";
	//var attributes = {codebase : "jar", code: 'robocode.Robocode', archive: 'robocode.jar', width:800, height:600};
		//var parameters = {Robots:SelectedRobs, numberofrounds:"10"};
		//var version = '1.7' ;
